...
public class connent_health_device extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connent_health_device);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (result != null) {
            ...
            if (scannedValue != null && scannedValue.equals(deviceId)) {
                ...
                Intent intent = new Intent(this, PatientHealthDetails.class); // Replace PatientHealthDetails with the actual activity class you want to open
